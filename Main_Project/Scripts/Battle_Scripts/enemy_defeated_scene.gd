...
@export var Lowest_Level_Undead_Dungeon_1_2: PackedScene = preload("res://Scenes/Battles/Undead_Dungeons/Lowest_Undead_Dungeons/lowest_undead_dungeon_1_2.tscn")
@export var Lowest_Level_Undead_Dungeon_1_1: PackedScene = preload("res://Scenes/Battles/Undead_Dungeons/Lowest_Undead_Dungeons/lowest_undead_dungeon_1_1.tscn")
...
func _on_next_button_button_up():
	...
	if DungeonData.lowest_level_undead == 1:
		Lowest_Level_Undead_Dungeons()
...
func Lowest_Level_Undead_Dungeons():
	if DungeonData.lowest_level_undead == 1:
		if DungeonData.next_scene == "Lowest_Level_Undead_Dungeon_1_101":
			Nxt_Button.visible = false
			return
		...
		for i in range(2, 101):  # Dungeon_1_2 to Dungeon_1_100
			var key = "Lowest_Level_Undead_Dungeon_1_" + str(i)
			dungeon_map[key] = (
				Lowest_Level_Undead_Dungeon_1_2 if i % 2 == 0 else Lowest_Level_Undead_Dungeon_1_1
			)
