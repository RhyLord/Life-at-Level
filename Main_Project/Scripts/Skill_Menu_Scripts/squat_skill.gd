...
func _ready():
	...
	desc.text = "Squats are a fundamental lower-body exercise that enhances leg strength, endurance, and overall mobility. Regular squatting builds powerful thighs, improves stability, and supports athletic performance."
	Off_combat_desc.text = "Active: Consumes [" + str(ceil(0.25 * Player.MAX_EN)) + "] EN, and grants [" + str(50 + Player.MAX_EN) + "] Squat EXP."
